package com.zcy.selector.internal.utils;
...
public final class PhotoMetadataUtils {
    ...
    public static IncapableCause isAcceptable(Context context, Item item) {
        ...
        if (SelectionSpec.getInstance().getFilters() != null) {
            for (Filter filter : SelectionSpec.getInstance().getFilters()) {
    ...
    private static boolean isSelectableType(Context context, Item item) {
        ...
        for (MimeType type : SelectionSpec.getInstance().getMimeTypeSet()) {
